...
test('wellknown', function(t) {
    ...
    t.deepEqual(parse('MULTILINESTRING Z ((30 10 1, 10 30 2, 40 40 3), (30 10 4, 10 30 5, 40 40 6))'), {
        type: 'MultiLineString',
        coordinates: [
            [[30, 10, 1], [10, 30, 2], [40, 40, 3]],
            [[30, 10, 4], [10, 30, 5], [40, 40, 6]]]
    });

    t.deepEqual(parse('MULTIPOLYGON Z (((30 20 1, 10 40 2, 45 40 3, 30 20 1)), ((15 5 4, 40 10 5, 10 20 6, 5 10 7, 15 5 4)))'), {
        type: 'MultiPolygon',
        coordinates: [
            [[[30, 20, 1], [10, 40, 2], [45, 40, 3], [30, 20, 1]]],
